...
mpra_colannot <- read.table(
	glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{lib}{adaptor}_col_annot_comparative_improved.txt"),
	header=T, sep='\t', stringsAsFactors=F, quote="", row.names=1)
mpra_data_DNA <- read.table(
	glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{lib}{adaptor}_DNA_MPRAnalyze_comparative_filter_adjusted_fdr.txt"),
	header=T, sep='\t', stringsAsFactors=F, quote="", row.names=1)
mpra_data_RNA <- read.table(
	glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{lib}{adaptor}_RNA_MPRAnalyze_comparative_filter_adjusted_fdr.txt"),
	header=T, sep='\t', stringsAsFactors=F, quote="", row.names=1)
...
mpra_data_RNA_small <- read.table(glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/rna_chunks_{input}/{rnaname}"), header=F, sep='\t', stringsAsFactors=F, quote="", row.names=1)
mpra_data_DNA_small <- read.table(glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/dna_chunks_{input}/{dnaname}"), header=F, sep='\t', stringsAsFactors=F, quote="", row.names=1)
...
# save results
write.table(res, file=glue("/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{lib}{adaptor}/output/mpranalyze_comparative/{project}/res_{input}/{name}.txt"), 
