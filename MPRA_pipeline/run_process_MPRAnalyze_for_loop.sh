...
#module load R/4.1.0
bsub -q long -R "rusage[mem=30000]" -e ./$6/$4$5/log/log_mpranalyze_comparative/$3_%J.e.txt -o ./$6/$4$5/log/log_mpranalyze_comparative/$3_%J.o.txt Rscript /home/labs/davidgo/Collaboration/backup/humanMPRA/scripts/MPRAnalyze_for_loop.R $1 $2 $3 $4 $5 $6 $7
