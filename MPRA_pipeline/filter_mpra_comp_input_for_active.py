...
input_comparative_rna_active.to_csv(f'/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{library}{adaptor}/output/mpranalyze_comparative/{cells}_{library}{adaptor}_RNA_MPRAnalyze_comparative_filter_adjusted_fdr.txt', sep='\t', header=True, index=False)
input_comparative_dna_active.to_csv(f'/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{library}{adaptor}/output/mpranalyze_comparative/{cells}_{library}{adaptor}_DNA_MPRAnalyze_comparative_filter_adjusted_fdr.txt', sep='\t', header=True, index=False)
