...
input_comparative_dna = pd.read_csv(f'./{cells}/{library}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{library}{adaptor}_DNA_MPRAnalyze_comparative_filter_adjusted_fdr{additional_sequences}.txt', sep='\t', header =0)
input_comparative_rna = pd.read_csv(f'./{cells}/{library}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{library}{adaptor}_RNA_MPRAnalyze_comparative_filter_adjusted_fdr{additional_sequences}.txt', sep='\t', header =0)
...
input_comparative_rna_to_save.to_csv(f'/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{library}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{library}{adaptor}_RNA_MPRAnalyze_comparative_filter_adjusted_fdr_sorted{additional_sequences}.txt', sep='\t', header=False, index=False)
input_comparative_dna_to_save.to_csv(f'/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{library}{adaptor}/output/mpranalyze_comparative/{project}/{cells}_{library}{adaptor}_DNA_MPRAnalyze_comparative_filter_adjusted_fdr_sorted{additional_sequences}.txt', sep='\t', header=False, index=False)
...
with open(f'/home/labs/davidgo/Collaboration/humanMPRA/{cells}/{library}{adaptor}/output/mpranalyze_comparative/{project}/split_positions{additional_sequences}.txt', 'w') as f:
